function [o, time, out]=function_chen_depth_p(depth,pH,DIC,Temp,K_AB,K_MB,K_hco3)
...
[time, out]=ode15s(@(t,y0) carbonate(t, y0, o.TK,o.kf1,o.kf4,o.kb1,o.kb4,o.K1,o.K2,o.Kw,o.Ksp,o.CO2sw,o.HCO3sw,o.CO3sw,o.Casw,o.Srsw,o.Hsw,o.OHsw,o.z,o.Dcell,o.P,o.fCa,o.FAlk,o.k_A1,o.v_A1,o.v_M1,o.K_AB,o.K_MB,o.K_hco3), t, y0, options);
end
...
%Set parameters
o.FAlk =4.7E-06;%1.2e-6;%1e-6;              %moles/m2/s
% o.FAlk =8E-06;%1.2e-6;%1e-6;              %moles/m2/s

o.P =	4.0E-06;%1.2e-6;%1e-6;  
o.fCa = 1;
o.Dcell =15e-6;        %m/s
...
o.v_A1=1598000*exp(-930.7/o.TK);%2D
o.v_A2=o.v_A1;
o.v_A=o.v_A1+o.v_A2;

o.v_M1=16030000000000*exp(-5396/o.TK);%2D
o.v_M2=o.v_M1;
o.v_M=o.v_M1+o.v_M2;
% 
...
function dy=carbonate(~,y,TK,kf1,kf4,kb1,kb4,K1,K2,Kw,Ksp,CO2sw,HCO3sw,CO3sw,Casw,Srsw,Hsw,OHsw,z,Dcell,P,fCa,FAlk,k_A1,v_A1,v_M1,K_AB,K_MB,K_hco3)
dy=zeros(size(y));
DIC = y(1)+y(2);
KN = 0;
NT = 0;
...
pH = -log10(H);
chi = 1/(1+K2/H);
omega = y(3)*(1-chi)*y(2)/Ksp;  %CO3 = y(2)(1-chi) 
HCO3=y(2)*chi;
CO3=y(2)*(1-chi);
...
for i=1:20
    ...
    Rnet = 1.137*h*(I*v_st^2)^(1/3); % Calcite growth rate
...
dy(1) = -kf1*y(1)+kb1*y(2)*chi*H - kf4*y(1)*OH+kb4*y(2)*chi + Dcell/z*(13e-6-y(1));
dy(2) = kf1*y(1)-kb1*y(2)*chi*H + kf4*y(1)*OH-kb4*y(2)*chi + P/z*(HCO3sw-HCO3) - 1/z*JCaCO3+ P/z*(CO3sw-CO3);
dy(3) = P/z*(Casw-y(3))-1/z*JCaCO3*(1-x)+1/z*0.5*FAlk/1000*Casw/(Casw+Srsw);
dy(4) = P/z*(HCO3sw-HCO3)+1/z*(FAlk/1000-2*JCaCO3)+ P/z*2*(CO3sw-CO3)+P/z*(OHsw-OH)-P/z*(Hsw-H);
dy(5) = P/z*(Srsw-y(5))-1/z*JCaCO3*x+1/z*0.5*FAlk/1000*Srsw/(Casw+Srsw);
